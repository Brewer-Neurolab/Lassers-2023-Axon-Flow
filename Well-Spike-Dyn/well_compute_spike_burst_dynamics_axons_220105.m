function [spike_burst_dyn_table]=well_compute_spike_burst_dynamics_axons_220105(allregion_unit_matched)
...
for fi=1:length(allregion_unit_matched)
    ...
    for regi = 1:4
        ...
        for ui =1:length(timestamps)
            ...
            [ISI, ibi_sec, IBSR, spnb, bd_msec, SR_val] = compute_spike_burst_dynamics_200304...
                (timestamps{ui}');
            end
            ...
            chan_name_cell = [chan_name_cell, string(chan2comp(ui))+"-"+ui];
...
spike_burst_dyn_table = table(fi_vec',regi_vec',chan_name_cell', SR_vec', ISI_cell', IBI_cell', IBSR_cell', spnb_cell', bd_cell',....
    'VariableNames',{'fi','regi','channel_name', 'SpikeRate','ISI','IBI','IntraBurstSpikeRate','SpikeperBurst','BurstDuration'});
