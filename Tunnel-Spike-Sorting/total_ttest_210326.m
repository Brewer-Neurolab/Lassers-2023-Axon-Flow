function [h, p, ci, stats, n, stderr1, stderr2]=total_ttest_210326(table1, table2)
...
if all([table1{1}.Direction{1:end}])
    title("All Channels: Feed Forward",'FontSize',fontsize)
elseif ~all([table1{1}.Direction{1:end}])
    title("All Channels: Feed Back",'FontSize',fontsize)
else
    title("All Channels: CHECK DIRECTION",'FontSize',fontsize)
end
