function [h, p, stats, n, stderr1, stderr2]=total_wilcox_downreg_210630(table1, table2)
...
if all([table1{1}.Direction{1:end}])
    title("T-Test Bar Graph Downregulation: Feed Forward",'FontSize',fontsize)
elseif ~all([table1{1}.Direction{1:end}])
    title("T-Test Bar Graph Downregulation: Feed Back",'FontSize',fontsize)
else
    title("T-Test Bar Graph Downregulation: CHECK DIRECTION",'FontSize',fontsize)
end
