function [h, p, ci, stats, n, stderr_spon, stderr_stim]=no_pad_ttest_210319(table1, table2)
...
[total_h, total_p, total_ci, total_stats,total_n, total_stderr_spon, total_stderr_stim]=total_ttest_210326(table1,table2);
%%
[total_h_up, total_p_up, total_ci_up, total_stats_up,total_n_up, total_stderr_up_spon, total_stderr_up_stim]=total_ttest_upreg_210326(table1,table2);
%%
[total_h_down, total_p_down, total_ci_down, total_stats_down,total_n_down, total_stderr_down_spon, total_stderr_down_stim]=total_ttest_downreg_210326(table1,table2);

%%
h={total_h total_h_up total_h_down};
p={total_p total_p_up total_p_down};
ci={total_ci total_ci_up total_ci_down};
