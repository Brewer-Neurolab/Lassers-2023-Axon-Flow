function [h, p, stats, n, stderr1, stderr2]=total_wilcox_upreg_210630(table1, table2)
...
if all([table1{5}.Direction{1:end}])
    title("T-Test Bar Graph Upregulation: Feed Forward",'FontSize',fontsize)
elseif ~all([table1{5}.Direction{1:end}])
    title("T-Test Bar Graph Upregulation: Feed Back",'FontSize',fontsize)
else
    title("T-Test Bar Graph Upregulation: CHECK DIRECTION",'FontSize',fontsize)
end
