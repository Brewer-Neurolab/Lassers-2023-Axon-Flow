clear
clc
% outfolder = "D:\Brewer lab data\HFS\Temporal Analysis\5 HFS\AFR Output";
outfolder = "D:\Brewer lab data\HFS\Temporal Analysis\5 HFS\AFR Output Full Index";
load("D:\Brewer lab data\HFS\Temporal Analysis\5 HFS\dataInfo.mat")
names=dataInfo.meaName;
% MFR_threshold = 0.0333;
MFR_threshold = 0.2; %original 0.2
bin_AFR_s = 0.1;
bin_lm_s=1; 
no_points_thresh = 5;
...
% load("D:\Brewer lab data\HFS\HFS Stim\24-Nov-2021_A\allregion_unit_matched_stim.mat")                 %allregion structure with showing matching of sorted unit between tunnel channel sets and their directions
...
% data_folder_addr = "D:\Brewer lab data\HFS\Theta Stim\xcorr_pseudo_times"; %corrected dir 4/7/22
