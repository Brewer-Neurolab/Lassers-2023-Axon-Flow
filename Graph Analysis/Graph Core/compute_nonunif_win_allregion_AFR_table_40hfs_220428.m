...
outfolder = "D:\Brewer lab data\HFS\Temporal Analysis\40 HFS\AFR Output Full Index nonuniform win 4pts";
...
AFR_table_w_lmfit = compute_allregion_time_dependent_linear_model(AFR_table, bin_AFR_s,bin_lm_s, no_points_thresh, well_type);
clear AFR_table;
