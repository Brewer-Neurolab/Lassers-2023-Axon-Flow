...
outfolder = "D:\Brewer lab data\HFS\Temporal Analysis\5 HFS\AFR Output Full Index slide 10sLM";
...
load('D:\Brewer lab data\HFS\Temporal Analysis\5 HFS\tunnelChannelList.mat')                                  %List of tunnel channels whether near target or source
load('D:\Brewer lab data\HFS\Temporal Analysis\5 HFS\dataInfo.mat')                                           %Names of MEA's and their orientations
...
% load("D:\Brewer lab data\HFS\Theta Stim\10-May-2022_A\allregion_unit_matched_stim.mat")
...
data_folder_addr = "D:\Brewer lab data\HFS\Theta Stim\full_index_pseudo_times"; %fixed from theta stim 4/7/22
...
for fi = 1:6
    tunnel_unit_mea_ff = load(data_folder_addr+'\'+dataInfo.meaName{fi}+"/mea_tunnels_ff");
    tunnel_unit_mea_fb = load(data_folder_addr+'\'+dataInfo.meaName{fi}+"/mea_tunnels_fb");
    %tunnel_unit_mea=[];
    ...
    for regi = 1:4
        well_mea = load(data_folder_addr+'\'+dataInfo.meaName{fi}+"/mea_"+well_regList(well_regi(regi)));
