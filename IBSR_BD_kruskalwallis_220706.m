...
for i=1:length(regions)
    ...
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_ff_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_ff_ibsr),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedforward IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_ff_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_ff_ibsr),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedforward IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_ff_40HFS_",regions(i),".png"))
...
%     histogram(log10(nostim_ff_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Feedforward IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_ff_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_ff_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Feedforward IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_ff_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_ff_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Feedforward IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_ff_40HFS_",regions(i),".png"))
    
    
%     figure
    [~,~,stats]=kruskalwallis(hist_vec,stim_group);
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Box_ff_",regions(i),".png"))
    figure
    ...
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Bar_ff_",regions(i),".png"))
...
saveas(gcf,strcat(".\three stim share figs\median_IBSR_Bar_ff.png"))
%% Feedback
...
%     histogram(log10(nostim_fb_ibsr),100)
    ...
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_fb_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_fb_ibsr),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedback IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_fb_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_fb_ibsr),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedback IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_fb_40HFS_",regions(i),".png"))
...
%     histogram(log10(nostim_fb_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Feedback IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_fb_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_fb_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Feedback IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_fb_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_fb_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Feedback IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_fb_40HFS_",regions(i),".png"))
    
%     figure
    [~,~,stats]=kruskalwallis(hist_vec,stim_group);
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Box_fb_",regions(i),".png"))
    figure
    [ff_c,ff_means]=multcompare(stats);
    ...
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Bar_fb_",regions(i),".png"))
...
saveas(gcf,strcat(".\three stim share figs\median_IBSR_Bar_fb.png"))
...
%     histogram(log10(nostim_fb_ibsr),100)
    ...
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_well_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_fb_ibsr),100)
    ...
    ax.FontSize=18;
    title(strcat("Well IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_well_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_fb_ibsr),100)
    ...
    ax.FontSize=18;
    title(strcat("Well IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Hist_well_40HFS_",regions(i),".png"))
...
%     histogram(log10(nostim_fb_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Well IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_well_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_fb_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Well IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_well_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_fb_ibsr),100)
    ...
    xlabel("Log(IBSR)")
    title(strcat("Well IBSR ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_IBSR_Hist_well_40HFS_",regions(i),".png"))
    
%     figure
    [~,~,stats]=kruskalwallis(hist_vec,stim_group);
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Box_well_",regions(i),".png"))
    figure
    [ff_c,ff_means]=multcompare(stats);
    ...
    saveas(gcf,strcat(".\three stim share figs\median_IBSR_Bar_Well_",regions(i),".png"))
...
saveas(gcf,strcat(".\three stim share figs\median_IBSR_Bar_well.png"))
...
%     histogram(log10(nostim_ff_bd),100)
    ...
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_ff_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_ff_bd),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedforward BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_ff_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_ff_bd),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedforward BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_ff_40HFS_",regions(i),".png"))
...
%     histogram(log10(nostim_ff_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Feedforward BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_ff_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_ff_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Feedforward BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_ff_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_ff_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Feedforward BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_ff_40HFS_",regions(i),".png"))
    
%     figure
    [~,~,stats]=kruskalwallis(hist_vec,stim_group);
    saveas(gcf,strcat(".\three stim share figs\median_BD_Box_ff_",regions(i),".png"))
    figure
    [ff_c,ff_means]=multcompare(stats);
    ...
    saveas(gcf,strcat(".\three stim share figs\median_BD_Bar_ff_",regions(i),".png"))
...
saveas(gcf,strcat(".\three stim share figs\median_BD_Bar_ff.png"))
%% Feedback
...
%     histogram(log10(nostim_fb_bd),100)
    ...
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_fb_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_fb_bd),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedback BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_fb_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_fb_bd),100)
    ...
    ax.FontSize=18;
    title(strcat("Feedback BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_fb_40HFS_",regions(i),".png"))
...
%     histogram(log10(nostim_fb_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Feedback BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_fb_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_fb_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Feedback BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_fb_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_fb_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Feedback BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_fb_40HFS_",regions(i),".png"))
    
%     figure
    [~,~,stats]=kruskalwallis(hist_vec,stim_group);
    saveas(gcf,strcat(".\three stim share figs\median_BD_Box_fb_",regions(i),".png"))
    figure
    [ff_c,ff_means]=multcompare(stats);
    ...
    saveas(gcf,strcat(".\three stim share figs\median_BD_Bar_fb_",regions(i),".png"))
...
saveas(gcf,strcat(".\three stim share figs\median_BD_Bar_fb.png"))
%% BD Well
cd("D:\Brewer lab data\HFS\")
nostim=load('D:\Brewer lab data\HFS\No Stim\Wells_5SD_500maxSD\well_spike_dynamics_table_nostim.mat');
hfs5=load('D:\Brewer lab data\HFS\Theta Stim\Wells_5SD_500maxSD\well_spike_dynamics_table_theta.mat');
...
%     histogram(log10(nostim_ff_bd),100)
    ...
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_well_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_ff_bd),100)
    ...
    ax.FontSize=18;
    title(strcat("Well BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_well_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_ff_bd),100)
    ...
    ax.FontSize=18;
    title(strcat("Well BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_BD_Hist_well_40HFS_",regions(i),".png"))
...
%     histogram(log10(nostim_ff_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Well BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_well_NoStim_",regions(i),".png"))
...
%     histogram(log10(hfs5_ff_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Well BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_well_5HFS_",regions(i),".png"))
...
%     histogram(log10(hfs40_ff_bd),100)
    ...
    xlabel("Log(BD)")
    title(strcat("Well BD ",regions(i)))
    saveas(gcf,strcat(".\three stim share figs\median_log_BD_Hist_well_40HFS_",regions(i),".png"))
    
%     figure
    [~,~,stats]=kruskalwallis(hist_vec,stim_group);
    saveas(gcf,strcat(".\three stim share figs\median_BD_Box_well_",regions(i),".png"))
    figure
    [ff_c,ff_means]=multcompare(stats);
    ...
    saveas(gcf,strcat(".\three stim share figs\median_BD_Bar_well_",regions(i),".png"))
...
saveas(gcf,strcat(".\three stim share figs\median_BD_Bar_well.png"))
